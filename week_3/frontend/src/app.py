...
async def get_chart_data():
    ...
    return {
        "quality": {
            "labels": ["High Quality", "Low Quality (Quarantine)"],
            "data": [high_jobs, low_jobs],
        },
        "companies": {
            "labels": [row["company"] for row in top_companies],
            "data": [row["count"] for row in top_companies],
        },
    }
